...
`sparseTools` is an R package that implements an S4 class for sparse
numeric vectors, called `sparse_numeric`.

Its use is to provide a class for sparse numeric vectors along with
methods to work witht hose vectors without ever converting them to a
dense vector
